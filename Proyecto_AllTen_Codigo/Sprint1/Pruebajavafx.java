 ...
 * + botón "Cómo jugar" que abre InstruccionesView.fxml (misma lógica que
 * MainSceneController.abrirInstrucciones(), hecha por el compañero de equipo).
 *
 ...
 *
 * Paleta unificada con la pantalla de instrucciones del equipo (instrucciones.css):
 * fondo #F1EFE8, azul #7EB6E8, naranja #F5A623, verde #97C459, texto #2D1B69.
 */
public class Pruebajavafx extends Application {

    // ----- Paleta (unificada con instrucciones.css del equipo) -----
    ...
    private static final String COLOR_NUM_ACTIVE    = "#7EB6E8"; // antes #85B7EB
    ...
    private static final String COLOR_NUM_TEXT      = "#2D1B69"; // antes #042C53, ahora igual a btn-categoria-activo
    private static final String COLOR_OP_ACTIVE     = "#F5A623"; // antes #EF9F27
    private static final String COLOR_OP_TEXT       = "#FFFFFF"; // antes #412402, ahora igual a btn-categoria
    private static final String COLOR_CTRL_ACTIVE   = "#6B7280"; // gris azulado para (, ), ⌫, ↺
    private static final String COLOR_CTRL_TEXT     = "#FFFFFF";
    private static final String COLOR_EQUALS_BG     = "#2D1B69"; // antes #2C2C2A, ahora el morado del equipo
    ...
    public void start(Stage stage) {
        ...
        root.getChildren().add(buildComoJugarButton());

        Scene scene = new Scene(root, 520, 860);
    ...
    /**
     * Botón "Cómo jugar": misma lógica que MainSceneController.abrirInstrucciones().
     * Requiere que InstruccionesView.fxml (y su controlador controller.InstruccionesController)
     * estén en el classpath del proyecto, bajo /view/InstruccionesView.fxml.
     */
    private Button buildComoJugarButton() {
        Button btn = new Button("Como jugar");
        btn.setStyle(
                "-fx-background-color: " + COLOR_OP_ACTIVE + ";" + // mismo naranja que btnComoJugar en MainMenuView
                "-fx-text-fill: #FFFFFF;" +
                "-fx-font-size: 16px;" +
                "-fx-font-weight: bold;" +
        ...
        btn.setOnAction(e -> abrirInstrucciones());
        return btn;
    }
    ...
    private void abrirInstrucciones() {
        try {
            ...
            System.out.println("ERROR: no se pudo abrir InstruccionesView.fxml: " + ex.getMessage());
        }
    }
